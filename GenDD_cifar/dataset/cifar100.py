...
def get_cifar100_trainval_dataloader(batch_size=128, num_workers=8, is_instance=False):
    """
    cifar 100
    """
...
def get_cifar100_dataloaders2(batch_size=128, num_workers=8, is_instance=False):
    """
    cifar 100
    """
    data_folder = get_data_folder()
