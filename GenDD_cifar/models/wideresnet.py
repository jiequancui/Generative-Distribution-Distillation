...
class WideResNet(nn.Module):
    def __init__(self, depth=34, num_classes=100, widen_factor=10, dropRate=0.0, normalized_cls=False):
    ...
    def forward(self, x, is_feat=False, mode='robust'):
        #self.set_bn(mode)
...
def WideResNet34_10(num_classes=100, normalized_cls=None):
