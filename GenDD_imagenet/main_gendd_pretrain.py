...
parser.add_argument('--num_sampling', type=int, default=1.0, help=" sampling for representation aggregation ")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # student model
    model = DiffModel(model, classifier, feature_dim=args.feature_dim_s, target_dim=args.feature_dim_t, stage='stage-1')
