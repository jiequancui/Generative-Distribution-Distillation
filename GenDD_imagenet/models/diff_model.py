...
class DiffModel(nn.Module):
    def __init__(self, model, classifier=None, feature_dim=1024, target_dim=1024, smooth=0.9, num_sampling=1, 
            stage="stage-2", beta=1.0, diffloss_d=3, diffloss_w=1024,  num_sampling_steps='64', diffusion_batch_mul=10, token_dim=64, cond_drop_prob=0.2, finetune_classifier=False, grad_checkpointing=False):
