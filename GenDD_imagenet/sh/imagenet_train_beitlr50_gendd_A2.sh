#!/bin/bash
#SBATCH --job-name=imagenet_beitlargeres50_gendd_A2
#SBATCH --mail-user=jiequancui@link.cuhk.edu.hk
#SBATCH --output=imagenet_beitlargeres50_gendd_A2.log
...
python main_gendd_pretrain.py -a resnet50 \
	       ...
	       -b 512 \
	       --epochs 20 \
	       --mark 'workdir/imagenet_beitlargeres50_pretrain_20e_A2' \
...
python main_supervised_gendd.py -a resnet50 \
	       ...
	       -j 64 \
	       -b 512 \
	       --reload 'workdir/imagenet_beitlargeres50_pretrain_20e_A2/checkpoint.pth.tar' \
	       --mark 'workdir/imagenet_beitlargeres50_gendd_A2' \
	       /mnt/proj198/jqcui/Data/ImageNet
