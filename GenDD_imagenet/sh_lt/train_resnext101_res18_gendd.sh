#!/bin/bash
#SBATCH --job-name=imagenetlt_gendd_resnext101res18
#SBATCH --mail-user=jiequancui@link.cuhk.edu.hk
#SBATCH --output=imagenetlt_gendd_resnext101res18.log
...
python main_gendd_lt.py -a resnet18 \
	       ...
	       -j 64 \
	       -b 256 \
               --mark 'workdir_lt/imagenetlt_resnext101res18_gendd_unsupervised' \
