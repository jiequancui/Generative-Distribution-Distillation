...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # student model
    model = DiffModel(model, model_t.fc, feature_dim=args.feature_dim_s, target_dim=args.feature_dim_t, stage='stage-2', smooth=args.smooth, beta=args.beta, diffloss_w=args.diffloss_w, diffusion_batch_mul=args.diffusion_batch_mul)
    ...
    optimizer = torch.optim.AdamW(param_groups, betas=(0.9, args.adam_beta), lr=args.lr)
