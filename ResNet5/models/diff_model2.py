...
class DiffModel(nn.Module):
    def __init__(self, model, classifier=None, finetune_classifier=False, feature_dim=1024, target_dim=1024, diffloss_d=3, diffloss_w=1024,  num_sampling_steps='64', diffusion_batch_mul=50, grad_checkpointing=False, stage="stage-1", smooth=0.8, beta=1.0):
        ...
        if stage == 'stage-2':
            ...
            self.ln = nn.LayerNorm(self.target_dim, elementwise_affine=True)
    ...
    def forward_train_stage2(self, x, y, target_feature, weight=None):
        ...
        z = self.ln(self.cls_projector(feats[-1]))
