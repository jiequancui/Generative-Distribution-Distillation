...
def param_groups_setup(model, args, skip_list=()):
    ...
    return [
        {'params': diff_params, 'weight_decay': 0., 'lr': args.lr},
        {'params': non_diff_params, 'weight_decay': args.weight_decay, 'lr': args.lr},]
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # student model
    model = DiffModel(model, model_t.fc, feature_dim=args.feature_dim_s, target_dim=args.feature_dim_t, stage='stage-1')
