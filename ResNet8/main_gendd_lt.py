...
from models.diff_model_lt import DiffModel
...
parser.add_argument('--diffusion_batch_mul', type=int, default=4, help="warmup epochs")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # student model
    model = DiffModel(model, classifier, feature_dim=args.feature_dim_s, target_dim=args.feature_dim_t, stage='stage-2', smooth=args.smooth, beta=args.beta, diffloss_w=args.diffloss_w, diffusion_batch_mul=args.diffusion_batch_mul, token_dim=args.token_dim, cond_drop_prob=args.cond_drop_prob, finetune_classifier=args.finetune_classifier)
