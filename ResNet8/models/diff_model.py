...
class DiffModel(nn.Module):
    def __init__(self, model, classifier=None, finetune_classifier=False, feature_dim=1024, target_dim=1024, diffloss_d=3, diffloss_w=1024,  num_sampling_steps='64', diffusion_batch_mul=5, grad_checkpointing=False, stage="stage-2", smooth=0.9, beta=1.0, token_dim=64, cond_drop_prob=0.2):
