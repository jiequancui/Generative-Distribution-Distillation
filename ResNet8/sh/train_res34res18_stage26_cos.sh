#!/bin/bash
#SBATCH --job-name=res34res18_lr2e-3_wd5e-2_stage26_1024_mix_w07_bt512_cos
#SBATCH --mail-user=jiequancui@link.cuhk.edu.hk
#SBATCH --output=res34res18_lr2e-3_wd5e-2_stage26_1024_mix_w07_bt512_cos.log
...
python main_distill_stage26_cosine.py -a resnet18 \
	       ...
	       -j 64 \
	       -b 512 \
	       --mark 'workdir/res34res18_lr2e-3_wd5e-2_stage26_1024_mix_w07_bt512_cos' \
