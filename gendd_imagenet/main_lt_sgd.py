...
model_names = ['resnet18', 'resnet34', 'resnet50', 'MobileNetV1', 'resnext101_32x4d']
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dummy:
        ...
        train_dataset = ImageNetLT(root=args.data, txt=txt_train, transform=train_transform)
    ...
    if args.evaluate:
        validate(val_loader, train_loader, model, criterion, args)
        return
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        acc1 = validate(val_loader, train_loader, model, criterion, args)
