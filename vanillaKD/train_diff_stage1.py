...
def main():
    ...
    if args.identical_init:
        ...
        for i in range(setting_num):
            ...
            model = DiffModel(model, teacher.head, feature_dim=args.feature_dim_s, target_dim=args.feature_dim_t, stage='stage-1')
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        for i in range(setting_num):
            ...
            with amp_autocast():
                ...
                diffloss, output = model_list[i](student_input, target[i], target_feature=feats[-1])
